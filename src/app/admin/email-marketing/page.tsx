        ...
        <div className="px-6 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Gestiona campañas automatizadas y analiza el rendimiento</p>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600">Para 156 usuarios inactivos</p>
                  </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600">Programada para mañana</p>
                  </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600">Línea de asunto optimizada</p>
                  </div>
